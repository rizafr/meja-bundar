				...
				<div class="row-fluid">
					<div style="width: 800px; margin: 0 auto; text-align:center">
						<div class="well well-sm wow fadeInDown">
							...
							<h4>.:: <?= $q_instansi->nama_instansi;?> ::.</h4>
						</div>
					</div>
					<div style="width: 400px; margin: 0 auto;">
						<div class="well well-sm">
							<img src="<?php echo base_url(); ?><?php echo $q_instansi->logo_instansi; ?>" class="thumbnail span3" style="display: inline; float: left; margin-right: 20px; width: 80px; height: 80px">
							<h3 style="margin: 5px 0 0.4em 0; font-size: 21px; color: #000; font-weight: bold"><?php echo $q_instansi->nama_instansi; ?></h3>
							<div style="color: #000; font-size: 13px" class="clearfix"><?php echo $q_instansi->alamat_instansi; ?></div>
						</div>
					</div>
