...
<div class="ae-container-fluid ae-container-fluid--inner rk-main">
    <div class="ae-grid">
        <div class="ae-grid__item item-lg-6 item-lg--offset-7">
            ...
            <p class="au-mb-4 contact__desc">Say hello by phone, mail or LINE <br>We're standing by to help.</p>
        </div>
    </div>
    <div class="ae-grid">
            ...
            <div class="ae-grid ae-grid--collapse">
                <div class="ae-grid__item item-lg-2 au-v-hidden au-lg-v-visible">
                    <button id="map-arrow" class="arrow-button arrow-button--nospace arrow-button--center arrow-button--flip">
                        <svg>
                            <use xlink:href="<?php echo base_url(); ?>/asset-meja-bundar/assets/img/symbols.svg#arrow"></use>
                        </svg>
                    </button>
                </div>
                <div class="ae-grid__item item-lg-10 au-xs-ta-center au-lg-ta-left">
                    <p class="au-mb-4 contact__addr">Jl. Gudang Selatan No.22<br> Kota Bandung <br>Jawa Barat, ID</p>
                    <p> <span class="contact__phone"> <span class="rk-light-color">Phone  </span> +62 8122 054 6136 </span><br><span class="contact__email au-block au-truncate"> <span class="rk-light-color">LINE &nbsp;&nbsp; </span><a href="#0">gunawahid</a></span> <span class="rk-light-color">Email &nbsp;&nbsp; </span><a href="mailto:contact@mejabundarinc.com">contact@mejabundarinc.com</a></span></p>
                </div>
...
<p class="au-xs-ta-right au-pt-4">
